...
// Enhanced Data Sets for Silicon Valley Level Analytics
const riskData = [
  { name: 'Critical', value: 12, color: '#DC2626', fill: 'url(#criticalGradient)' },
  { name: 'High', value: 28, color: '#EA580C', fill: 'url(#highGradient)' },
  { name: 'Medium', value: 45, color: '#D97706', fill: 'url(#mediumGradient)' },
  { name: 'Low', value: 67, color: '#16A34A', fill: 'url(#lowGradient)' }
]

const threatTrends = [
  { month: 'Jul', threats: 45, incidents: 8, prediction: 42, anomaly: 0.2 },
  { month: 'Aug', threats: 52, incidents: 12, prediction: 48, anomaly: 0.8 },
  { month: 'Sep', threats: 38, incidents: 6, prediction: 41, anomaly: 0.1 },
  { month: 'Oct', threats: 61, incidents: 15, prediction: 58, anomaly: 0.5 },
  { month: 'Nov', threats: 47, incidents: 9, prediction: 50, anomaly: 0.3 },
  { month: 'Dec', threats: 54, incidents: 11, prediction: 52, anomaly: 0.4 }
]

const securityMetrics = [
  { category: 'Network Security', score: 94, target: 95, trend: [88, 90, 92, 94] },
  { category: 'Data Protection', score: 87, target: 90, trend: [82, 85, 86, 87] },
  { category: 'Access Control', score: 96, target: 95, trend: [93, 95, 95, 96] },
  { category: 'Compliance', score: 89, target: 90, trend: [85, 87, 88, 89] },
  { category: 'Incident Response', score: 92, target: 95, trend: [87, 89, 91, 92] },
  { category: 'Threat Intelligence', score: 85, target: 88, trend: [80, 82, 84, 85] }
]
